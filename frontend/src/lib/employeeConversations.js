...
export const CONVERSATION_TOPICS = {
  ...
  [topicKey('cisco-packet-tracer', 'basic-device-configuration')]: {
    ...
    questions: [
      ...
      { id: 'cisco-basic-11', difficulty: 'medium', text: 'Du bist im Interface-Konfigurationsmodus und willst schnell die gesamte running-config sehen, ohne den Modus zu verlassen. Wie?', options: ['end gefolgt von show running-config', 'do show running-config', 'exit gefolgt von show running-config', 'configure terminal'], correct: 1, explanation: '"do <Privileged-EXEC-Befehl>" führt den Befehl direkt aus dem aktuellen Konfigurationsmodus aus.' },
    ],
  },
  [topicKey('cisco-packet-tracer', 'router-basics')]: {
