    ...
    skills: {
      basic_configuration: {
        ...
        subskills: {
          ...
          hostname: { label: 'Hostname konfigurieren', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          disable_dns_lookup: { label: 'DNS-Lookup abschalten (no ip domain-lookup)', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          enable_secret: { label: 'Enable Secret setzen', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          local_user: { label: 'Lokale Benutzer anlegen', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          console_security: { label: 'Console-Sicherheit (password/secret)', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          login: { label: 'Line-Login aktivieren', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          login_local: { label: 'Login local vs. login', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          exec_timeout: { label: 'EXEC-Timeout konfigurieren', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          service_password_encryption: { label: 'service password-encryption', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          do_command: { label: 'EXEC-Befehle aus Konfigurationsmodus mit do', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
          ...
          default_gateway: { label: 'Default Gateway (Switch-Management)', lessonTopic: 'cisco-packet-tracer/grundkonfiguration' },
