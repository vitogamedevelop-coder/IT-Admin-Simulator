...
export const ACADEMY_TOPICS = [
  ...
  topic('fundamentals', 'binary-system', 'Zahlensysteme', 'Binär-, Dezimal-, Hexadezimal- und Oktalzahlen lesen und umrechnen.'),
  topic('fundamentals', 'ipv4', 'IP-Adressen', 'Logische IP-Adressierung sowie Aufbau und Notation von IPv4 und IPv6.', ['tcp-ip-model', 'binary-system']),
  ...
  // Stick, MLS/SVI). The troubleshooting lesson then bundles the L2/L3
  // diagnostic skills before the edge-security topics begin.
  ...
  // ---------------------------------------------------------------------
  // Phase 8: five big blocks, then the existing detail topics below them.
  topic('information-security', 'security-fundamentals', 'Block 1: Grundlagen', 'Informationssicherheit, IT-System Bundeswehr, Schutzziele, PIMO, OPTI, ISMS und PDCA.'),
  topic('information-security', 'security-legal-data', 'Block 2: Recht & Datenschutz', 'Rechtliche Grundlagen, Informationskategorien, Schutzbereiche, Datenschutz, Art. 9 DSGVO.', ['security-fundamentals']),
  topic('information-security', 'security-incidents', 'Block 3: Verstöße & Meldewesen', 'Informationssicherheitsverstoß, Sicherheitsvorkommnis, Meldebewusstsein, Meldewege.', ['security-fundamentals']),
  topic('information-security', 'security-threats-malware', 'Block 4: Gefährdungen & Malware', 'Angriffsmethoden, Social Engineering, Malware-Taxonomie und Prävention.', ['security-fundamentals']),
  topic('information-security', 'security-technical-measures', 'Block 5: Technische Schutzmaßnahmen', 'Zugriff, Filterung, Firewall, DMZ, IDS/IPS und technische Maßnahmen im Zusammenspiel.', ['security-fundamentals']),
  // Detail topics feed both the Academy cards and the conversation knowledge layer.
  topic('information-security', 'security-objectives', 'Schutzziele', 'Die klassischen Ziele der Informationssicherheit.', ['security-fundamentals']),
  ...
  topic('information-security', 'passwords', 'Passwörter', 'Anforderungen an sichere Passwörter.', ['security-fundamentals']),
  topic('information-security', 'mfa', 'Multi-Faktor-Authentifizierung', 'Absicherung von Zugängen durch mehrere Faktoren.', ['passwords']),
  topic('information-security', 'phishing', 'Phishing', 'Betrügerische Nachrichten erkennen.', ['security-threats-malware']),
  topic('information-security', 'malware', 'Malware', 'Arten von Schadsoftware und ihre Wirkung.', ['security-threats-malware']),
  topic('information-security', 'backup', 'Backup', 'Datensicherung als Schutz vor Datenverlust.', ['security-technical-measures', 'availability']),
  topic('information-security', 'logging', 'Logging', 'Protokollierung sicherheitsrelevanter Ereignisse.', ['security-technical-measures']),
  topic('information-security', 'firewall-basics', 'Firewall-Grundlagen', 'Wie eine Firewall Netzwerkverkehr kontrolliert.', ['security-technical-measures']),
  topic('information-security', 'hardening', 'Hardening', 'Systeme durch Reduktion der Angriffsfläche absichern.', ['firewall-basics']),
  topic('information-security', 'incident-response', 'Incident Response', 'Reaktion auf sicherheitsrelevante Vorfälle.', ['security-incidents']),
  topic('information-security', 'pimo', 'PIMO', 'Personelle, infrastrukturelle, materielle und organisatorische Elemente des IT-Systems.', ['security-fundamentals']),
  topic('information-security', 'opti', 'OPTI', 'Organisatorische, personelle, technische und infrastrukturelle Informationssicherheitsmaßnahmen.', ['security-fundamentals']),
  topic('information-security', 'isms', 'ISMS', 'Informationssicherheits-Managementsystem: Planen, Umsetzen, Überprüfen, Verbessern.', ['security-fundamentals']),
  topic('information-security', 'pdca', 'PDCA', 'Der PDCA-Zyklus als Verbesserungsmodell für ein ISMS.', ['security-fundamentals']),
  topic('information-security', 'data-protection', 'Datenschutz & Schutzbereiche', 'Unterschied Datenschutz, Informationssicherheit, Geheimschutz; interne Schutzbereiche.', ['security-legal-data']),
  topic('information-security', 'art9-dsgvo', 'Art. 9 DSGVO', 'Besondere Kategorien personenbezogener Daten.', ['security-legal-data']),
  topic('information-security', 'information-categories', 'Informationskategorien', 'Öffentliche, offene und Verschlusssachen-Informationen.', ['security-legal-data']),
  topic('information-security', 'security-breach', 'Informationssicherheitsverstoß', 'Verstoß gegen Sicherheitsvorschriften und -anforderungen.', ['security-incidents']),
  topic('information-security', 'security-incident', 'Sicherheitsvorkommnis', 'Ein Ereignis, das die Informationssicherheit negativ beeinflusst.', ['security-incidents']),
  topic('information-security', 'firewall-types', 'Firewall-Arten', 'Paketfilter, Stateful Inspection, Application Layer Gateway.', ['firewall-basics']),
  topic('information-security', 'ids-ips', 'IDS vs IPS', 'Intrusion Detection System und Intrusion Prevention System.', ['security-technical-measures']),
  topic('information-security', 'dmz', 'DMZ', 'Demilitarisierte Zone als getrenntes Netzsegment.', ['security-technical-measures']),
  topic('information-security', 'allowlist-denylist', 'Allowlist & Denylist', 'Erlaubnis- und Verweigerungslisten für Objekte/Aktionen.', ['security-technical-measures']),
  topic('information-security', 'malware-types', 'Malware-Arten', 'Virus, Wurm, Trojaner, Spyware, Keylogger, Ransomware, Rootkit, Backdoor.', ['security-threats-malware']),
  topic('information-security', 'attacks', 'Angriffsmethoden', 'DoS, Identitätsdiebstahl, Social Engineering und menschliche Faktoren.', ['security-threats-malware']),
  topic('information-security', 'malware-prevention', 'Malware-Prävention', 'Defense in Depth gegen Schadsoftware.', ['security-threats-malware']),
  topic('information-security', 'required-level', 'Gefordertes Maß', 'Angemessenheit von Sicherheitsmaßnahmen im Verhältnis zu Schutzbedarf und Risiko.', ['security-fundamentals']),
