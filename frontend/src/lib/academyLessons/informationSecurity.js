...
export function buildInformationSecurityLegalDataLesson() {
  ...
  const explanations = [
    explanation('b2-einstieg', 'Drei Ebenen trennen', 'classic', [
      { type: 'text', content: 'Aus Block 1 kennst du bereits Vertraulichkeit, Integrität und Verfügbarkeit als Grundwerte. Block 2 fügt hinzu: Datenschutz, Schutzbereiche personenbezogener Daten und Geheimhaltung/Informationskategorien. Diese drei Ebenen sind verwandt, aber nicht identisch. Jede Ebene beantwortet eine eigene Frage.' },
