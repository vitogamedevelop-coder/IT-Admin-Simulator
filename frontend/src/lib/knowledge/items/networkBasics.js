...
const DNS_ITEMS = [
  ...
  },
  {
    ...
    data: {
      pairs: [
        ...
        { key: 'AAAA', value: 'Name → IPv6-Adresse' },
        { key: 'PTR', value: 'IP-Adresse → Name / Reverse Lookup' },
        { key: 'CNAME', value: 'Alias → anderer kanonischer Name' },
        { key: 'MX', value: 'Zuständiger Mailserver einer Domain' },
        { key: 'SRV', value: 'Dienst und zuständigen Server auffinden' },
        { key: 'SOA', value: 'Zentrale Verwaltungsinformationen einer Zone' },
        { key: 'NS', value: 'Zuständiger Nameserver einer Zone' },
      ],
  ...
  },
  {
    ...
    data: {
      steps: [
        ...
        { id: 'server', label: 'Client fragt den konfigurierten Resolver rekursiv' },
        { id: 'data', label: 'DNS-Server prüft eigene Zone und Cache' },
        { id: 'forwarder', label: 'Server nutzt gegebenenfalls einen passenden Forwarder' },
        { id: 'hierarchy', label: 'Falls nötig werden iterative Referrals verfolgt' },
        { id: 'answer', label: 'Record wird zurückgegeben und gemäß TTL gespeichert' },
      ],
      description: 'Typischer vereinfachter Ablauf im verwendeten Szenario; Cache, Zonendaten und Konfiguration können Schritte verkürzen.',
    },
    siblings: [],
    roleHints: ['technical'],
  },
  {
    id: 'nb.dns.domainZone',
    topicKey: DNS_TOPIC_KEY,
    sourceTopicKey: DNS_TOPIC_KEY,
    sourceSection: 'zonen-classic',
    conceptCluster: 'dns.domainZone.compare',
    type: KNOWLEDGE_TYPES.COMPARE,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.COMPARE, QUESTION_ARCHETYPES.SELECT_BEST],
    data: {
      compareOn: 'description',
      items: [
        { name: 'Domain', description: 'Logischer Bereich im hierarchischen DNS-Namensraum.' },
        { name: 'Zone', description: 'Administrativ verwalteter Teil des Namensraums, für den DNS-Daten vorgehalten werden.' },
      ],
      description: 'Domain und Zone können ähnlich aussehen, bezeichnen aber unterschiedliche Konzepte.',
    },
    siblings: [],
    roleHints: ['technical'],
  },
  {
    ...
    topicKey: DNS_TOPIC_KEY,
    sourceTopicKey: DNS_TOPIC_KEY,
    sourceSection: 'aufbau-classic',
    conceptCluster: 'dns.fqdn.property',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.EASY,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.RECALL],
    data: {
      subject: 'Fully Qualified Domain Name (FQDN)',
      description: 'Vollständiger hierarchischer Pfad eines Namens bis zur Root; der formale abschließende Punkt wird im Alltag meist weggelassen.',
      distractorDescriptions: ['Ausschließlich die numerische IPv4-Adresse eines Hosts ohne irgendeine Position innerhalb des hierarchischen DNS-Namensraums.', 'Nur der kurze Alias eines CNAME-Records ohne zugehörige Domain, Subdomain oder formale Root-Ebene.', 'Eine einzelne Top-Level-Domain ohne Host, weitere Domain-Labels oder vollständigen hierarchischen Pfad bis zur Root.'],
    },
    siblings: [],
    roleHints: ['technical', 'support'],
  },
  {
    id: 'nb.dns.queryTypes',
    topicKey: DNS_TOPIC_KEY,
    sourceTopicKey: DNS_TOPIC_KEY,
    sourceSection: 'query-types-classic',
    conceptCluster: 'dns.queryTypes.compare',
    type: KNOWLEDGE_TYPES.COMPARE,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.COMPARE, QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.SCENARIO],
    data: {
      compareOn: 'description',
      items: [
        { name: 'rekursiv', description: 'Der Anfragende erwartet eine vollständige Antwort oder einen Fehler.' },
        { name: 'iterativ', description: 'Eine Antwort kann auf den nächsten zuständigen Nameserver verweisen.' },
      ],
      description: 'Cache oder bekannte Referrals können den iterativen Einstieg verkürzen; Root ist kein zwingender Start jeder Anfrage.',
    },
    siblings: [],
    roleHints: ['technical'],
  },
  {
    ...
    topicKey: DNS_TOPIC_KEY,
    sourceTopicKey: DNS_TOPIC_KEY,
    sourceSection: 'authority-forwarding-classic',
    conceptCluster: 'dns.authority.property',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.TROUBLESHOOT],
    data: {
      subject: 'Autorität eines DNS-Servers',
      description: 'Autorität gilt bezogen auf eine konkrete Zone; derselbe Server kann für eine Zone autoritativ und für eine andere nicht autoritativ sein.',
      distractorDescriptions: ['Autorität ist eine dauerhafte globale Eigenschaft eines Servers und gilt deshalb unverändert für sämtliche DNS-Namen und Zonen.', 'Jede aus einem lokalen oder entfernten Cache gelieferte DNS-Antwort ist automatisch für die angefragte Zone autoritativ.', 'Ausschließlich die benannten Root-Server können für irgendeine DNS-Zone maßgebliche autoritative Daten bereitstellen.'],
    },
    siblings: [],
    roleHints: ['technical'],
  },
  {
    id: 'nb.dns.forwardingDelegation',
    topicKey: DNS_TOPIC_KEY,
    sourceTopicKey: DNS_TOPIC_KEY,
    sourceSection: 'authority-forwarding-classic',
    conceptCluster: 'dns.forwardingDelegation.compare',
    type: KNOWLEDGE_TYPES.COMPARE,
    difficulty: DIFFICULTY.HARD,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.COMPARE, QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.SCENARIO],
    data: {
      compareOn: 'description',
      items: [
        { name: 'Forwarding', description: 'Eine Anfrage wird an einen anderen Resolver weitergegeben.' },
        { name: 'Delegierung', description: 'Verantwortung für einen Teil des Namensraums wird an autoritative Nameserver übertragen.' },
      ],
      description: 'Forwarding bestimmt einen Auflösungsweg; Delegierung strukturiert die hierarchische Zuständigkeit.',
    },
    siblings: [],
    roleHints: ['technical'],
  },
  {
    id: 'nb.dns.troubleshooting',
    topicKey: DNS_TOPIC_KEY,
    sourceTopicKey: DNS_TOPIC_KEY,
    sourceSection: 'praxis-fehler-classic',
    conceptCluster: 'dns.troubleshooting.property',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.TROUBLESHOOT, QUESTION_ARCHETYPES.SCENARIO, QUESTION_ARCHETYPES.SELECT_BEST],
    data: {
      subject: 'den Fehlerfall „IP erreichbar, FQDN nicht erreichbar“',
      symptom: 'IP-Adresse ist erreichbar, der zugehörige FQDN aber nicht',
      cause: 'DNS-Namensauflösung oder Client-DNS-Konfiguration prüfen',
      verification: 'nslookup oder Resolve-DnsName verwenden und DNS-Server/Record kontrollieren',
      description: 'Funktionierende IP-Erreichbarkeit bei fehlerhaftem Namen grenzt den Verdacht auf DNS ein.',
      distractorDescriptions: [
        'Die erfolgreiche IP-Verbindung beweist, dass ausschließlich das physische Netzwerkkabel defekt sein kann.',
        'Der Fehler muss von einer falschen Subnetting-Sprungweite des erreichbaren Zielservers verursacht werden.',
        'Ein fehlender MX-Record verhindert grundsätzlich jede A- und AAAA-Namensauflösung im gesamten Netzwerk.',
      ],
    },
    siblings: [],
...
const DHCP_ITEMS = [
  {
    ...
    difficulty: DIFFICULTY.EASY,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.RECALL, QUESTION_ARCHETYPES.SELECT_BEST],
    facets: ['dhcp-definition', 'dhcp-options'],
    data: {
      term: 'DHCP',
    ...
    siblings: ['nb.dhcp.dora', 'nb.dhcp.options', 'nb.dhcp.lease'],
    roleHints: ['technical', 'support'],
  },
  {
    id: 'nb.dhcp.options',
    ...
    sourceTopicKey: DHCP_TOPIC_KEY,
    sourceSection: 'was-classic',
    conceptCluster: 'dhcp.options',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.EASY,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.RECALL, QUESTION_ARCHETYPES.SELECT_BEST],
    facets: ['dhcp-options', 'dhcp-definition'],
    data: {
      subject: 'DHCP-Optionen',
      description: 'DHCP verteilt typischerweise IP-Adresse, Subnetzmaske, Standardgateway und DNS-Server.',
      distractorDescriptions: [
        'DHCP verteilt nur IP-Adressen; Gateway und DNS müssen immer manuell konfiguriert werden.',
        'DHCP legt die MAC-Adresse eines Clients fest.',
        'DHCP übersetzt Domain-Namen in IP-Adressen.',
      ],
    },
    siblings: ['nb.dhcp.definition', 'nb.dhcp.dora'],
    roleHints: ['technical', 'support'],
  },
  {
    id: 'nb.dhcp.dora',
    ...
    difficulty: DIFFICULTY.EASY,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.ORDERING, QUESTION_ARCHETYPES.SELECT_BEST],
    facets: ['dora', 'discover', 'offer', 'request', 'ack'],
    data: {
      steps: [
  ...
  {
    id: 'nb.dhcp.extraMessages',
    topicKey: DHCP_TOPIC_KEY,
    sourceTopicKey: DHCP_TOPIC_KEY,
    sourceSection: 'dora-classic',
    conceptCluster: 'dhcp.extraMessages',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.MATCHING],
    facets: ['dhcp-extra-messages', 'dora'],
    data: {
      subject: 'Zusätzliche DHCP-Nachrichten',
      description: 'NAK lehnt ab, Decline meldet einen Adresskonflikt, Release gibt die Lease zurück und Inform fragt nur Optionen ab.',
      distractorDescriptions: [
        'NAK bedeutet, dass der Client die Lease verlängert hat.',
        'Decline wird vom Server gesendet, wenn ein Pool leer ist.',
        'Inform fordert eine neue IP-Adresse an.',
      ],
    },
  ...
  },
  {
    ...
    sourceTopicKey: DHCP_TOPIC_KEY,
    sourceSection: 'dora-classic',
    conceptCluster: 'dhcp.ports',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.EASY,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.RECALL, QUESTION_ARCHETYPES.SELECT_BEST],
    facets: ['udp-ports', 'dora'],
    data: {
      subject: 'DHCPv4-Ports',
      description: 'DHCPv4 verwendet UDP-Port 67 auf dem Server und UDP-Port 68 auf dem Client.',
      distractorDescriptions: [
        'DHCPv4 verwendet TCP 67/68.',
        'DHCP-Server und Client verwenden beide UDP 67.',
        'DHCP nutzt UDP 53, weil es zur Transportschicht gehört.',
      ],
    },
    siblings: ['nb.dhcp.dora', 'nb.dhcp.definition'],
    roleHints: ['technical'],
  },
  {
    id: 'nb.dhcp.lease',
    topicKey: DHCP_TOPIC_KEY,
    sourceTopicKey: DHCP_TOPIC_KEY,
    sourceSection: 'lease-classic',
    conceptCluster: 'dhcp.lease',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.EASY,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.RECALL, QUESTION_ARCHETYPES.SELECT_BEST],
    facets: ['lease', 'renew', 'rebind'],
    data: {
      subject: 'DHCP-Lease',
      description: 'Eine Lease ist eine befristete Zuweisung von Netzwerkparametern mit typischerweise 50 % Renew und 87,5 % Rebind.',
      distractorDescriptions: [
        'Eine DHCP-Lease gilt dauerhaft und kann nicht ablaufen.',
        'Renew findet erst bei 100 % der Lease-Dauer statt.',
        'Eine Lease vergibt die MAC-Adresse des Clients neu.',
      ],
    },
    siblings: ['nb.dhcp.dora', 'nb.dhcp.relay'],
    roleHints: ['technical', 'support'],
  },
  {
    id: 'nb.dhcp.relay',
    topicKey: DHCP_TOPIC_KEY,
    sourceTopicKey: DHCP_TOPIC_KEY,
    sourceSection: 'relay-classic',
    conceptCluster: 'dhcp.relay',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.SCENARIO],
    facets: ['relay', 'broadcast-domain'],
    data: {
      subject: 'DHCP Relay Agent',
      description: 'Ein DHCP Relay Agent sitzt auf dem Gateway des Clientnetzes und leitet DHCP-Broadcasts als Unicast an den DHCP-Server weiter.',
      distractorDescriptions: [
        'Router leiten DHCP-Broadcasts standardmäßig automatisch in alle verbundenen Netze weiter.',
        'Ein Relay-Agent ersetzt den DHCP-Server und verteilt selbstständig IP-Adressen an Clients.',
        'Ein Relay-Agent ist ausschließlich bei manuell gesetzten statischen IP-Adressen erforderlich.',
      ],
    },
    siblings: ['nb.dhcp.dora', 'nb.dhcp.lease'],
    roleHints: ['technical'],
  },
  {
    id: 'nb.dhcp.allocation',
    topicKey: DHCP_TOPIC_KEY,
    sourceTopicKey: DHCP_TOPIC_KEY,
    sourceSection: 'modes-classic',
    conceptCluster: 'dhcp.allocation',
    type: KNOWLEDGE_TYPES.COMPARE,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.COMPARE, QUESTION_ARCHETYPES.SELECT_BEST],
    facets: ['allocation-mode'],
    data: {
      compareOn: 'description',
      items: [
        { name: 'Statisch / Reservierung', description: 'Feste IP für einen bestimmten Client, meist per MAC-Adresse, zentral verwaltet' },
        { name: 'Automatisch', description: 'Einmal automatisch zugewiesen und dauerhaft gebunden' },
        { name: 'Dynamisch', description: 'IP aus dem Pool mit zeitlich begrenzter Lease' },
      ],
      description: 'DHCP kennt statische Reservierungen, automatische und dynamische Vergabe.',
    },
    siblings: ['nb.dhcp.definition', 'nb.dhcp.lease'],
    roleHints: ['technical', 'support'],
  },
  {
    id: 'nb.dhcp.apipa',
    ...
    sourceTopicKey: DHCP_TOPIC_KEY,
    sourceSection: 'praxis-fehler-classic',
    conceptCluster: 'dhcp.apipa',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.EASY,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.TROUBLESHOOT],
    facets: ['apipa', 'dhcp-troubleshooting'],
    data: {
      subject: 'APIPA',
      description: 'Eine Adresse aus 169.254.0.0/16 ist ein starker Hinweis, dass der Client keine reguläre DHCP-Konfiguration erhalten hat.',
      distractorDescriptions: [
        '169.254.x.x bedeutet, dass der DHCP-Server definitiv kaputt ist.',
        'APIPA-Adressen werden vom DHCP-Server vergeben.',
        'Ein APIPA-Client hat eine gültige öffentliche IP-Adresse.',
      ],
    },
    siblings: ['nb.dhcp.lease', 'nb.dhcp.relay'],
    roleHints: ['technical', 'support'],
  },
  {
    id: 'nb.dhcp.redundancy',
    topicKey: DHCP_TOPIC_KEY,
    sourceTopicKey: DHCP_TOPIC_KEY,
    sourceSection: 'redundancy-classic',
    conceptCluster: 'dhcp.redundancy',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.COMPARE],
    facets: ['dhcp-redundancy'],
    data: {
      subject: 'DHCP-Ausfallsicherheit',
      description: 'Klassische Split-Scope-Modelle wie 80/20 oder 50/50 erfordern bei unabhängigen Servern nicht überlappende Pools; echtes Failover koordiniert Leases gemeinsam.',
      distractorDescriptions: [
        'Bei Split-Scope dürfen sich die Pools beider Server überschneiden, um mehr Adressen zu haben.',
        'DHCP-Ausfallsicherheit funktioniert nur mit mindestens drei Servern.',
        'Failover-Server teilen sich keine Lease-Informationen.',
      ],
    },
    siblings: ['nb.dhcp.definition', 'nb.dhcp.lease', 'nb.dhcp.allocation'],
    roleHints: ['technical'],
  },
];
...
const SUPERNETTING_ITEMS = [
  ...
  },
  {
    ...
    data: {
      ...
      description: 'Direkt zusammengefasste Geschwisterblöcke müssen gleich groß, benachbart und an der neuen Blockgrenze ausgerichtet sein; gemischte Präfixe werden schrittweise zusammengeführt.',
      distractorDescriptions: [
  ...
  {
    id: 'nb.supernetting.direction',
    topicKey: SUPERNETTING_TOPIC_KEY,
    sourceTopicKey: SUPERNETTING_TOPIC_KEY,
    sourceSection: 'supernetting-concept-classic',
    conceptCluster: 'supernetting.direction.compare',
    type: KNOWLEDGE_TYPES.COMPARE,
    difficulty: DIFFICULTY.EASY,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.COMPARE, QUESTION_ARCHETYPES.SELECT_BEST],
    data: {
      compareOn: 'description',
      items: [
        { name: 'Subnetting', description: 'Ein Netz wird in kleinere Netze geteilt; das Präfix wird größer.' },
        { name: 'Supernetting', description: 'Mehrere Netze werden zu einem größeren Bereich zusammengefasst; das Präfix wird kleiner.' },
      ],
      description: 'Beide Verfahren verschieben die Grenze zwischen Netz- und Hostanteil in entgegengesetzte Richtungen.',
    },
    siblings: [],
    roleHints: ['technical'],
  },
  {
    id: 'nb.supernetting.alignment',
    topicKey: SUPERNETTING_TOPIC_KEY,
    sourceTopicKey: SUPERNETTING_TOPIC_KEY,
    sourceSection: 'supernetting-validity-classic',
    conceptCluster: 'supernetting.alignment.property',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.TROUBLESHOOT],
    data: {
      subject: 'Alignment beim Supernetting',
      description: 'Benachbarschaft allein reicht nicht: Die neue Netz-ID muss an einer gültigen Grenze des kleineren Präfixes liegen.',
      distractorDescriptions: ['Jedes benachbarte Netzpaar kann unabhängig von seiner Netz-ID zusammengefasst werden.', 'Nur gleiche Default Gateways bestimmen die gültige Summary.', 'Alignment ist ausschließlich bei IPv6 relevant.'],
    },
    siblings: [],
    roleHints: ['technical'],
  },
  {
    id: 'nb.supernetting.expansion',
    topicKey: SUPERNETTING_TOPIC_KEY,
    sourceTopicKey: SUPERNETTING_TOPIC_KEY,
    sourceSection: 'supernetting-expansion-classic',
    conceptCluster: 'supernetting.expansion.property',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.HARD,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.TROUBLESHOOT],
    data: {
      subject: 'Adressraumerweiterung',
      description: 'Ohne Erlaubnis darf eine Summary keine Lücken oder fremden Netze einschließen; mit Erlaubnis wird die kleinste notwendige Erweiterung gewählt und dokumentiert.',
      distractorDescriptions: ['Adressraumerweiterung ist bei jeder Route Summary automatisch und ohne Prüfung fremder oder fehlender Netze unbegrenzt erlaubt.', 'Ohne Erweiterung müssen trotzdem sämtliche gegebenen Routen zwingend in genau einem einzigen großen Ergebnisnetz enden.', 'Die fachlich beste und kleinste sinnvolle Summary ist grundsätzlich immer die vollständige Default Route 0.0.0.0/0.'],
    },
    siblings: [],
    roleHints: ['technical', 'security'],
  },
  {
    id: 'nb.supernetting.partialResult',
    topicKey: SUPERNETTING_TOPIC_KEY,
    sourceTopicKey: SUPERNETTING_TOPIC_KEY,
    sourceSection: 'supernetting-validity-classic',
    conceptCluster: 'supernetting.partial.property',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.MEDIUM,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.SCENARIO],
    data: {
      subject: 'dem Endergebnis ohne Adressraumerweiterung',
      description: 'Nicht passende Netze dürfen separat bleiben; Ziel sind möglichst wenige korrekte Einträge, nicht zwangsläufig genau eine Summary.',
      distractorDescriptions: ['Supernetting ist nur korrekt, wenn am Ende exakt ein Netz übrig bleibt.', 'Nicht passende Netze werden stillschweigend aus der Routingtabelle entfernt.', 'Jede Lücke wird automatisch als eigener Host behandelt.'],
    },
    siblings: [],
    roleHints: ['technical'],
  },
  {
    id: 'nb.supernetting.mixedPrefixes',
    topicKey: SUPERNETTING_TOPIC_KEY,
    sourceTopicKey: SUPERNETTING_TOPIC_KEY,
    sourceSection: 'supernetting-mixed-classic',
    conceptCluster: 'supernetting.mixed.property',
    type: KNOWLEDGE_TYPES.PROPERTY,
    difficulty: DIFFICULTY.HARD,
    allowedQuestionTypes: [QUESTION_ARCHETYPES.SELECT_BEST, QUESTION_ARCHETYPES.SCENARIO],
    data: {
      subject: 'gemischten Präfixen beim Supernetting',
      description: 'Zuerst werden passende kleinere Geschwisterblöcke zusammengeführt; danach werden Nachbarschaft, Alignment und Abdeckung erneut geprüft.',
      distractorDescriptions: ['Alle Präfixe werden ohne Zwischenschritt auf den kleinsten Zahlenwert gesetzt.', 'Gemischte Präfixe können grundsätzlich nie aggregiert werden.', 'Die Reihenfolge ist beliebig, weil Netzgrenzen keine Rolle spielen.'],
    },
    siblings: [],
    roleHints: ['technical'],
  },
