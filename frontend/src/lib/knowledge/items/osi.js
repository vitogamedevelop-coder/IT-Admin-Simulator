...
const OSI_LAYERS = [
  ...
  { num: 2, de: 'Sicherungsschicht', en: 'Data Link Layer', pdu: 'Frames', devices: ['Switch', 'Bridge', 'Access Point'], protocols: ['Ethernet', 'ARP', 'PPP', 'WLAN (MAC)'], responsibility: 'zuverlässige Übertragung im lokalen Netz über MAC-Adressen', typicalFaults: ['VLAN-Fehlkonfiguration', 'falsche MAC-Zuordnung'], mnemonic: 'Sicherung: Switche kennen MAC-Adressen und Frames.' },
